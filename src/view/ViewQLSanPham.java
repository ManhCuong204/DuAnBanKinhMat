 ...
 * @author nguyen cuong
 */
public class ViewQLSanPham extends javax.swing.JFrame {
...
//       this.detail(0);
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("QLSanPham", jTabbedPane4);
        ...
        jTabbedPane5.addTab("Ql Sản Phẩm", jPanel2);
        ...
        jTabbedPane5.addTab("QL Sản Phẩm Chi Tiết", jPanel3);
        ...
        jTabbedPane5.addTab("Thuộc Tính", jPanel4);
        ...
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addComponent(jTabbedPane5, javax.swing.GroupLayout.PREFERRED_SIZE, 602, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
    ...
    private void tblSanPhamCTMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSanPhamCTMouseClicked
        // Lấy chỉ số hàng từ bảng tblSanPhamCT
        int index = tblSanPhamCT.getSelectedRow();

        // Kiểm tra xem chỉ số hàng có hợp lệ không
        if (index != -1) {
            // Gọi phương thức detail chỉ khi có dữ liệu
            detail(index);
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewQLSanPham.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewQLSanPham().setVisible(true);
            }
        });
    }
